...
def is_complex_dtype(dtype: Dtype) -> _pybool:
...
def implicit_dtype(number: int | float | _pybool | complex, array_dtype: Dtype) -> Dtype:
    if isinstance(number, _pybool):
        number_dtype = bool
