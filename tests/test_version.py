...
from arrayfire.version import VERSION

# Regex to check that the current version set in `arrayfire.version` adheres to
...
def test_is_valid_helper(version: str, valid: bool) -> None:
